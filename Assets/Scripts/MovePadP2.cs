...
public class MovePadP2 : MonoBehaviour
{
    ...
    private bool AxisGamePadPlayer2;
    ...
    void Start()
    {
        ...
        moveLeft = controlSettingObject.GetComponent<ControlSettingSc>().player2Left;
        moveRight = controlSettingObject.GetComponent<ControlSettingSc>().player2Right;
        moveBump = controlSettingObject.GetComponent<ControlSettingSc>().player2Bump;

        AxisGamePadPlayer2 = controlSettingObject.GetComponent<ControlSettingSc>().Player2AxisMode;
        if (!AxisGamePadPlayer2)
        {
    ...
    {
        return Input.GetAxis("Horizontal2") < 0;
    }
    ...
    {
        return Input.GetAxis("Vertical2") > 0;
    }
